...
import io.routify.gateway.certificate.CertEventKafkaConsumer;
import io.routify.gateway.certificate.CertificateVaultLoader;
 ...
 * <ul>
 *   <li>A gateway route reload ({@link DynamicRouteRefreshListener})
...
public class GatewayResilienceConfigApplier {
     ...
     * a targeted re-load via {@link CertEventKafkaConsumer}.
     */
