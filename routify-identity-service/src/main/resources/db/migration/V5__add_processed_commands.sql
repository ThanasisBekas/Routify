...
CREATE TABLE IF NOT EXISTS routify_identity.processed_command (
...
CREATE INDEX idx_processed_command_processed_at
    ON routify_identity.processed_command (processed_at);

COMMENT ON TABLE routify_identity.processed_command
