...
CREATE INDEX idx_processed_command_processed_at
    ON routify_cert.processed_command (processed_at);

COMMENT ON TABLE routify_cert.processed_command
