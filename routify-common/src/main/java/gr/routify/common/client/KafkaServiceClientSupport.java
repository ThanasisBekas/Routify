...
public abstract class KafkaServiceClientSupport {
     ...
     *
     * @param topic        Target Kafka topic (see {@link gr.routify.common.event.KafkaTopics}).
     ...
     *
     * @param topic       Target command topic (see {@link gr.routify.common.event.KafkaTopics}).
