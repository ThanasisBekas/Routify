...
- `routing.io.routify.gateway.CircuitBreakerCommandKafkaConsumer` — listens for `CommandEvent.ForceCircuitBreaker` to allow operators to manually open/close/half-open per-route circuit breakers from the dashboard.
