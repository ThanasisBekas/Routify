...
import io.routify.ai.dto.RouteEvaluationResponse.VerdictAction;
import io.routify.ai.config.AiServiceConfig;
import io.routify.ai.metrics.AiFilterMetrics;
import io.routify.ai.prompt.PromptBuilderService;
 ...
 * {@link AiServiceConfig}). Swapping providers (OpenAI → Ollama →
...
public class AiFilterEvaluationService {
     ...
     * bounded thread pool (configured in {@link AiServiceConfig}),
