...
export const seedAuditEvents: AuditEntry[] = [
  ...
  },
  {
    ...
    aggregateType: 'USER',
    aggregateId: 'bbbbbbbb-0000-0000-0000-000000000003',
    actorId: 'admin',
    occurredAt: ago(90),
    recordedAt: ago(90),
  },
  ...
  },
  {
    ...
    aggregateType: 'FILTER',
    aggregateId: 'cccccccc-0000-0000-0000-000000000007',
    actorId: 'admin',
    occurredAt: ago(200),
    recordedAt: ago(200),
  },
  {
    ...
    aggregateId: 'ffffffff-0000-0000-0000-000000000001',
    actorId: 'admin',
    occurredAt: ago(300),
    recordedAt: ago(300),
  },
  {
    eventId: 'ae-010',
    tenantId: MOCK_TENANT_ID,
    eventType: 'GATEWAY_CONFIG_CHANGED',
    aggregateType: 'GATEWAY',
    aggregateId: 'gateway-1',
    actorId: 'admin',
    occurredAt: ago(400),
    recordedAt: ago(400),
  },
  {
    ...
    aggregateType: 'ROUTE',
    aggregateId: 'dddddddd-0000-0000-0000-000000000099',
    actorId: 'admin',
  ...
  },
  {
    ...
    aggregateType: 'USER',
    aggregateId: 'bbbbbbbb-0000-0000-0000-000000000002',
    actorId: 'admin',
    occurredAt: ago(600),
    recordedAt: ago(600),
  },
  ...
  },
  {
    ...
    aggregateType: 'FILTER',
    aggregateId: 'cccccccc-0000-0000-0000-000000000003',
    actorId: 'admin',
    occurredAt: ago(700),
    recordedAt: ago(700),
  },
  ...
  },
  {
    ...
    aggregateType: 'CERTIFICATE',
    aggregateId: 'ffffffff-0000-0000-0000-000000000004',
    actorId: 'admin',
    occurredAt: ago(900),
    recordedAt: ago(900),
  },
  ...
  },
  {
    eventId: 'ae-018',
    tenantId: MOCK_TENANT_ID,
    eventType: 'FILTER_DETACHED',
    aggregateType: 'FILTER',
    aggregateId: 'cccccccc-0000-0000-0000-000000000002',
    actorId: 'admin',
    occurredAt: ago(250),
    recordedAt: ago(250),
  },
  {
    ...
    aggregateType: 'USER',
    aggregateId: 'bbbbbbbb-0000-0000-0000-000000000099',
    actorId: 'admin',
    occurredAt: ago(1200),
    recordedAt: ago(1200),
  },
  {
    eventId: 'ae-020',
    tenantId: MOCK_TENANT_ID,
    eventType: 'GATEWAY_RELOAD_REQUESTED',
    aggregateType: 'GATEWAY',
    aggregateId: 'gateway-1',
    actorId: 'admin',
    occurredAt: ago(10),
