...
export const seedRoutes: RouteDto[] = [
  {
    ...
    filters: [
      ...
      },
      {
        ...
        filterName: 'Rate Limit — 100 req/min',
      ...
      {
        filterId: FILTER_AI_FILTER_ID,
        filterName: 'AI Security Filter',
