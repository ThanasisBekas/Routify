...
export const gatewayConfig: GatewayConfig = {
  ...
  rateLimitPolicies: [
    ...
    {
      id: 'rl-sliding-500',
      name: '500 req/5min (sliding)',
      description: 'Sliding window for user-facing APIs',
    ...
    {
      id: 'rl-disabled',
      name: '10 req/sec (disabled)',
      description: 'Strict burst-protection policy — currently disabled',
      algorithm: 'FIXED_WINDOW',
      keyResolver: 'API_KEY',
      replenishRate: 10,
      burstCapacity: 15,
