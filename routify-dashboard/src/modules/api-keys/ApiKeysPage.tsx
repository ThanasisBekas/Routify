      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Manage API keys for machine-to-machine authentication. Keys created here are automatically available to
            routes using the <span className="text-indigo-400 font-medium">API Key Auth</span> filter.
          </p>
        </div>
