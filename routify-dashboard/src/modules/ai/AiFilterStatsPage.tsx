/**
 * AiFilterStatsPage — per-route AI Filter monitoring dashboard.
 *
 * Displays:
 *  - ALLOW / BLOCK / FLAG verdict breakdown (pie chart + counters)
 *  - LLM latency percentiles (p50, p95, p99)
 *  - Cache hit rate gauge
 *  - Recent decision log (action, reason, confidence, latency, path, timestamp)
 *
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="rounded-xl bg-white/[0.03] border border-white/[0.06] p-4">
          <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">Verdict Distribution</p>
