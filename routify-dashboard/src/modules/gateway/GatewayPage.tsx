...
const TABS: {
  ...
  { id: 'tenant', label: 'Tenant Isolation', icon: Settings, description: 'Multi-tenancy enforcement' },
  {
    ...
    icon: Layers,
    description: 'Cross-cutting filters applied to all routes',
  },
]
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-white/[0.08] shrink-0">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-0.5">
            Full control over routing, security, resilience, and networking — changes persist to PostgreSQL and reload
            via Kafka
          </p>
        </div>
