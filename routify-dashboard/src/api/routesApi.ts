...
export const routesApi = {
  ...
  activate: (id: string) =>
    apiClient.post<RouteDto>(`${BASE}/${id}/activate`).then((r) => r.data),

  deactivate: (id: string) =>
    apiClient.post<RouteDto>(`${BASE}/${id}/deactivate`).then((r) => r.data),

  delete: (id: string) =>
    apiClient.delete(`${BASE}/${id}`).then((r) => r.data),

  clone: (id: string) =>
    apiClient.post<RouteDto>(`${BASE}/${id}/clone`).then((r) => r.data),
