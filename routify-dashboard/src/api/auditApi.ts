...
export const auditApi = {
  ...
  /** Replay statistics */
  getReplayStats: () => apiClient.get<ReplayStats>(`${ADMIN_BASE}/replay/stats`).then((r) => r.data),

  /** Replay a single failed request */
  replaySingle: (id: string) => apiClient.post<ReplayResult>(`${ADMIN_BASE}/replay/${id}`).then((r) => r.data),
