...
export const alertsApi = {
  ...
  create: (data: CreateAlertRuleRequest) => apiClient.post<AlertRule>(BASE, data).then((r) => r.data),
  ...
  unmute: (id: string) => apiClient.post<AlertRule>(`${BASE}/${id}/unmute`).then((r) => r.data),
