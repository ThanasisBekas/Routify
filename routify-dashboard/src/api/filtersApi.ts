...
export const filtersApi = {
  ...
  get: (id: string) => apiClient.get<FilterDefinitionDto>(`${BASE}/${id}`).then((r) => r.data),

  create: (req: CreateFilterRequest) => apiClient.post<FilterDefinitionDto>(BASE, req).then((r) => r.data),
  ...
  deprecatedUsage: () => apiClient.get<DeprecatedFilterUsageResult>(`${BASE}/deprecated-usage`).then((r) => r.data),
}
